pipeline{
    ...
    stages{
        stage("Build Docker image"){
         ...
         sh "scp -o StrictHostkeyChecking=no -r docker-files ec2-user@172.31.43.80:/home/ec2-user"
         sh "ssh -o StrictHostkeyChecking=no ec2-user@172.31.43.80 'bash ~/docker-files/docker-script.sh'"
