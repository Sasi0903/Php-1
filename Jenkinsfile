pipeline{
    ...
    stages{
        stage("Build Docker image"){
         ...
         sh "ssh -o StrictHostkeyChecking=no ec2-user@172.31.36.19 sudo docker build -t ${IMAGE_NAME} /home/ec2-user" 
         sh "ssh ec2-user@172.31.36.19 sudo docker login -u $USERNAME -p $PASSWORD"
         sh "ssh ec2-user@172.31.36.19 sudo docker push ${IMAGE_NAME}"  
